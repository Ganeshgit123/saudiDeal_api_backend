export default class MotorViewedProductDomain {
    ...
    public static createFromObject(data: any) {
        return new MotorViewedProductDomain(data.id, data.productId, data.userId, data.deviceId, data.createdAt, data.updatedAt,
